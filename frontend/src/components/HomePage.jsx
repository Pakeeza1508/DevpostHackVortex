...
import { Sparkles, Rocket, Star, Zap, Trophy, BookOpen, Play, User } from 'lucide-react';
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            >
              <div className="w-16 h-16 bg-gradient-to-br from-cyan-400 to-purple-500 rounded-full flex items-center justify-center shadow-2xl neon-border">
                <img
            ...
            <div>
              ...
              <p className="text-cyan-400 font-space text-lg">
                Space Academy for Dental Health
              </p>
            </div>
          </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h2 className="text-2xl font-orbitron text-white neon-glow">
                    Welcome, {user?.username || 'Space Explorer'}!
                  </h2>
                  <p className="text-gray-300 font-space mt-2">
                    Ready to explore the cosmos of dental health? Join Dr. Rabbit on an
                    epic journey through the galaxy of oral hygiene!
                  </p>
            ...
            >
              <div className="glass-card p-8 max-w-md mx-auto">
                ...
                <h3 className="text-xl font-orbitron text-white mb-2">
                  No missions available for Level {selectedLevel}
                </h3>
                <p className="text-gray-400 font-space">
                  Try selecting a different level or check back later for new missions!
                </p>
              </div>
            </motion.div>
          )}
